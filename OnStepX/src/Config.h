...
// =================================================================================================================================
// CONTROLLER ======================================================================================================================
#define HOST_NAME                "OnStepX" // nStep", Hostname for this device up to 16 chars.                                 Adjust
// PINMAP ------------------------------------------------- see https://onstep.groups.io/g/main/wiki/Configuration_Controller#PINMAP
#define PINMAP                        Juwei17max //    OFF, Choose from: MiniPCB, MiniPCB2, MaxPCB2, MaxESP3, CNC3, STM32Blue,      <-Req'd
...
#define SERIAL_B_ESP_FLASHING         ON //ON //    OFF, ON Upload ESP8266 WiFi firmware through SERIAL_B with :ESPFLASH# cmd.    Option
...
#define NV_DRIVER              NV_2464 // NV_DEF, Use platforms default non-volatile device to remember runtime settings.  Option
...
// \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ 
#define AXIS1_STEPS_PER_DEGREE      14222.22 //  12800, n. Number of steps per degree:                                          <-Req'd
...
#define AXIS1_DRIVER_MICROSTEPS_GOTO  16 //    OFF, n. Microstep mode used during slews. OFF uses _DRIVER_MICROSTEPS.        Option
...
#define AXIS1_DRIVER_IGOTO            1300 //    OFF, n, (mA.) Current during slews. OFF uses IRUN.                            Option
// /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /
...
#define AXIS1_SENSE_HOME              HIGH //  HIGH  OFF, HIGH or LOW enables & state clockwise home position, as seen from front. Option
...
// If runtime axis settings are enabled changes in the section below will be ignored (disable in SWS or by wiping NV/EEPROM):
// \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/
#define AXIS2_STEPS_PER_DEGREE      14222.22 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
...
#define AXIS2_DRIVER_MICROSTEPS_GOTO  16 //    OFF, n. Microstep mode used during slews. OFF uses _DRIVER_MICROSTEPS.        Option
...
#define AXIS2_DRIVER_IGOTO            1300 //    OFF, n, (mA.) Current during slews. OFF uses IRUN.                            Option
// /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /\ /
...
#define TIME_LOCATION_SOURCE          GPS // DS3231 STM32 //    OFF, DS3231 (I2C,) SD3031 (I2C,) TEENSY (T3.2 etc,) GPS, or NTP source.       Option
                                          //         Provides Date/Time, and if available, PPS & Lat/Long also.
#define TIME_LOCATION_SOURCE_FALLBACK STM32

#define TIME_LOCATION_PPS_SENSE       HIGH // HIGH //    OFF, HIGH senses PPS (pulse per second,) signal rising edge, or use LOW for   Option
...
#define FOCUSER_TEMPERATURE           DS1820 //    OFF, THERMISTOR or n. Where n is the ds18b20 s/n for focuser temp.            Adjust
...
#define FEATURE1_TEMP                 OFF //0x28489B75D0013CE4//    OFF, THERMISTOR or n. Where n is the ds18b20 s/n. For DEW_HEATER temperature. Adjust
